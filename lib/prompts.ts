...
export function buildGeneratePrompt(params: GenerateParams): string {
  ...
  const lines = [
    ...
    "- 객관식(mc)은 choices 배열(4개)과 정답 answer를 포함하라.",
    "  - choices의 각 항목에는 'A)', '①', '1.' 같은 순서 라벨을 붙이지 말고 보기 내용만 써라.",
    "  - answer는 choices 배열 항목 중 하나와 글자 하나까지 완전히 동일한 문자열이어야 한다.",
    "    'A'나 'B' 같은 라벨만 적지 말고, 정답 보기의 전체 문장을 그대로 반복해서 넣어라.",
